...
### bws_weapon
`bws_weapon [weapon]`
Specify which weapon all of the bots are given. Do not include the `weapon_` string. All of the give codes can be found here: https://totalcsgo.com/give-codes
